...
const char * const BITCOIN_CONF_FILENAME = "beacot.conf";
const char * const BITCOIN_PID_FILENAME = "beacot.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Beacot";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Beacot";
#else
    // Unix
    return pathRet / ".beacot";
#endif
#endif
}
