...
{
    const char* pszTimestamp = "This coin is created for Beacot project";
    const CScript genesisOutputScript = CScript() << ParseHex("010984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1632392819, 2000615810, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x054c683ba32641dac834029573c18a15cb155cd0c8a260b01f67e715a4032190"));
        assert(genesis.hashMerkleRoot == uint256S("0xbc80e1a5e15589029580e3f17305734791cc09c693699703efb37737733b19ed"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("3.0.128.62", "3.0.128.62", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("beacottools.com", "dnsseed.beacottools.com"));
        //vSeeds.push_back(CDNSSeedData("beacotpool.org", "dnsseed.beacotpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x054c683ba32641dac834029573c18a15cb155cd0c8a260b01f67e715a4032190"))
        ...
        chainTxData = ChainTxData{
            ...
            1632392819, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
       ...
       // consensus.BIP34Height = 76;
        ...
        genesis = CreateGenesisBlock(1632392819, 211907, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa4bef379bfb06fe27e51a758550b51fc1e009cbf60ac24a87b589aa1615d18b8"));
        assert(genesis.hashMerkleRoot == uint256S("0xbc80e1a5e15589029580e3f17305734791cc09c693699703efb37737733b19ed"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("3.0.128.62", "3.0.128.62"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.beacot.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xa4bef379bfb06fe27e51a758550b51fc1e009cbf60ac24a87b589aa1615d18b8")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1632392819, 2, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xace12fd4d0e491808794827fd56ef0bd3428fae11771198878212f8c72070966"));
        assert(genesis.hashMerkleRoot == uint256S("0xbc80e1a5e15589029580e3f17305734791cc09c693699703efb37737733b19ed"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xace12fd4d0e491808794827fd56ef0bd3428fae11771198878212f8c72070966"))
        };
