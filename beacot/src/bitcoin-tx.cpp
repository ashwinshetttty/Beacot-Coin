...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s beacot-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  beacot-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beacot transaction") + "\n" +
              "  beacot-tx [options] -create [commands]   " + _("Create hex-encoded beacot transaction") + "\n" +
              "\n";
